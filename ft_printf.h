...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/09 15:53:28 by stribuzi          #+#    #+#             */
/*   Updated: 2021/02/11 09:03:11 by stribuzi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_printabile	ft_int_helper_1 (t_printabile p,
		int num, char *support);
t_printabile	ft_int_helper_2 (t_printabile p,
		int num, char *support);
t_printabile	ft_int_helper_3(t_printabile p,
		int num, char *support);
t_printabile	ft_int_helper_4(t_printabile p);
t_printabile	ft_fratm_int(t_printabile p,
		va_list list);
t_printabile	ft_hex_handle_zero_support_3(t_printabile p);
t_printabile	ft_hex_helper_3(t_printabile p,
		char *support);
...
t_printabile	ft_fratm_hex_support1(t_printabile p, char *support);
t_printabile	ft_fratm_hex(t_printabile p, va_list list);
...
t_printabile	ft_fratm_unsigned_helper_2(t_printabile p,
		long support_unsigned_num);
t_printabile	ft_fratm_unsigned(t_printabile p, va_list list);
t_printabile	ft_fratm_pointer_handler_null_argument(t_printabile p);
t_printabile	ft_pointer_handle_multiple_flags(t_printabile p, char *support);
t_printabile	ft_fratm_pointer(t_printabile p,
		va_list list);
