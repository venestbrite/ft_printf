...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/09 16:54:57 by stribuzi          #+#    #+#             */
/*   Updated: 2021/02/11 09:01:03 by stribuzi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		va_list list)
{
	...
	if (!(num2 = (size_t)va_arg(list, unsigned long)))
		return (p = ft_fratm_pointer_handler_null_argument(p));
